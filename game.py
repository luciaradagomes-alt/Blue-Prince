...
from Chambres import Yellow, Green, RoomGrid
...
def enter_current_room():
    ...
    global show_room_interface, current_room_node, game_state, current_room_grid
    ...
    if hasattr(player, "last_move_dir"):
        entry_direction = player.last_move_dir
    else:
        entry_direction = "south"

    current_room_grid = RoomGrid(room, entry_direction)
    game_state = "room"
